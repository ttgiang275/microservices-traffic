...
@Schema(name = "Customer details",
        description = "Customer details to hold Customer and Account information")
public class CustomerDetailsDto {
    ...
    @Schema(name = "loan", description = "Loan details of the customer")
    private LoansDto loan;

    @Schema(name = "card", description = "Card details of the customer")
